...
//Email body
	$mail->Body = "<h1> Thank you for registering the ground."." ".$name.", you have booked ground on".$calender."</h1>, for further details you can contact us on +91 9738575108";
//Add recipient
...
$query1="insert into torna values('$name','$number','$email','$facility','$calender','$pay')";

  if ($connection->query($query1) === TRUE) {?>
  <div class="alert alert-success">
    <?php echo $calender;?> is available. Your total is <?php echo $pay;?>.
  </div>
<?php } else {?>
  <div class="alert alert-warning">
  <strong>Warning!</strong> date is not available.
</div>
<?php
}
