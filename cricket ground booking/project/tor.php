...
b=Number(document.getElementById("u").value);
d=Number(document.getElementById("v").value);
...
<div class="container row-75">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" pattern="[0-9]{10}" id="number" name="number" placeholder="Your number" class="input" required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    ...
    <div class="col-75">
	 ...
	 <input type="checkbox" name="check_list[]" value="500" id="wa">water
    <input type="checkbox" name="check_list[]" value="1000" id="u">Umpire
    <input type="checkbox" name="check_list[]" value="2000" id="v">Videography
...
<div class="row">
<div class="col-25">
      <label for="pt"><h3>Booking</h3></label>
    </div>
	<div class="col-75">
